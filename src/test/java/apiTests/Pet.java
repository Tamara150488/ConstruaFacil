...
public class Pet {
    ...
    public void incluirPet() throws IOException { // Create - Post
        ...
        .then()                                                 // Então
                ...
                .body("name", is("Neguinha"))         // Valida o nome do animal
    ...
    public void consultarPet(){
       // String petId = "1119"; // Id do animal
    ...
    public void alterarPet() throws IOException {
        ...
        given()
                .contentType("application/json")
                .log().all()
                .body(jsonBody) //Json a ser transmitido para alteração
        .when()
                .put(uri)
        .then()
                .log().all()
    ...
    public void excluirPet(){
            ...
            given()
                    ...
                    .log().all()
            .when()
                    .delete(uri + "/" + petId) // Delete == Excluir
            .then()
                    .log().all()
                    .statusCode(200)
                    .body("code", is(200))
