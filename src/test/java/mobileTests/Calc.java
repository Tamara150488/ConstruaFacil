    ...
    public void setUp() throws MalformedURLException {
        ...
        switch (ambiente) {
            ...
            case "remoto": // No SauceLabs
                ...
                desiredCapabilities.setCapability("appActivity", "com.android.calculator2.Calculator");
                desiredCapabilities.setCapability("ensureWebviewsHavePages", true);
                desiredCapabilities.setCapability("SAUCE_USERNAME", "oauth-tamarasilvagomes-a6cc9");
                desiredCapabilities.setCapability("SAUCE_ACCESS_KEY", "abb1cca9-1d80-4a2b-bbb2-4a8383eb9131");


                remoteUrl = new URL("https://oauth-tamarasilvagomes-a6cc9:abb1cca9-1d80-4a2b-bbb2-4a8383eb9131@ondemand.us-west-1.saucelabs.com:443/wd/hub");
                break;
            default:
                remoteUrl = new URL("http://localhost:4723/wd/hub");
                break;
